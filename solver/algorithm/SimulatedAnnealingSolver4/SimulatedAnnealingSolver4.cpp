...
Solution SimulatedAnnealingSolver4::solve(const Problem &problem) {
    Solution solution;
...
Coordinate SimulatedAnnealingSolver4::getPoint(const std::vector<int> &perm,
...
void SimulatedAnnealingSolver4::updateDistance(int index,
...
Cost SimulatedAnnealingSolver4::calculateNewCost(int l, int r,
                                                 const std::vector<int> &perm,
                                                 const Problem &problem,
...
Cost SimulatedAnnealingSolver4::calculateCostAfterSwapBack(
